...
from martian.openai.api_resources import (
    ChatCompletion,
    Completion,
    Engine,
    ErrorObject,
)
from martian.openai.error import APIError, InvalidRequestError, OpenAIError
from martian.openai.version import VERSION
...
martian_api_key_path: Optional[str] = os.environ.get("MARTIAN_API_KEY_PATH")

organization = os.environ.get("OPENAI_ORGANIZATION")
api_base = os.environ.get(
    "OPENAI_API_BASE", "https://route.withmartian.com/api/openai/v1"
)
if os.environ.get("MARTIAN_TESTING_ENV"):
    api_base = "http://localhost:8000/openai/v1"
